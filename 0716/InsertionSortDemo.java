class InsertionSortDemo {
     ...
     * 插入排序的核心思想與時間排序（如時間戳排序）相似：
     * 將元素逐一插入已排序的序列中，適用於需要維護時間順序的場景。
     */
    ...
    /**
     * 二分插入排序：使用二分搜尋找到插入位置
     * 二分插入排序可優化時間排序的比較次數（O(log n)），
     * 但元素移動次數仍為 O(n²)，適用於需要高效維護時間順序的場景。
     */
    ...
    public static void main(String[] args) {
        ...
        // 若要排序時間對象（如 java.time.LocalTime），
        // 只需將 int[] 替換為 LocalTime[]，並修改比較邏輯即可。
        // 插入排序的核心邏輯（逐個插入維護有序性）適用於任何可比較對象。
    }
}